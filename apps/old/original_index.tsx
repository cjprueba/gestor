    ...
    <div className="container mx-auto p-6">
      <div className="flex flex-col space-y-4 mb-8 md:flex-row md:justify-between md:items-center md:space-y-0">
              ...
              <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                <DialogTrigger asChild>
                  <Button>
                    ...
                    Nuevo <span className="hidden md:inline">{" proyecto"}</span>
                  </Button>
                </DialogTrigger>
        ...
        {/* <CreateProjectForm
          ...
          onSubmit={(projectData, selectedFolders, folderConfigs) => {
            // Crear el proyecto con los nuevos datos
            const newProject: Project = {
              id: Date.now().toString(),
              ...
              structure: {
                ...
                minDocuments: 0,
                documents: [],
                subfolders: selectedFolders.map((folderName) => ({
              ...
              // Agregar los nuevos campos del proyecto
              etapa: projectData.etapa,
